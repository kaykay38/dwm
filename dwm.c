...
#define ISINSTACK(C)            (ISVISIBLE(C) && !C->isfloating)
...
enum { SchemeNorm, SchemeSel, SchemeSystray }; /* color schemes */
...
static void shiftviewtag(const Arg *arg);
